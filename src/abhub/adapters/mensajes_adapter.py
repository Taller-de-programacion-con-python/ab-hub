...
- Si el paquete `mensajes` (de 1��) estǭ disponible, usa sus claves y su funci��n t().
- Si no, usa un FALBACK local con las claves m��nimas para la demo/CLI.
...
try:
    ...
    _CATALOGO = {
        "auth_ok": "Inicio de sesi��n correcto",
        "auth_fail": "Usuario o contrase��a no vǭlidos",
        "user_exists": "El usuario ya existe",
        "invalid_input": "Datos incompletos o invǭlidos",

        "task_added": "Tarea agregada",
        "task_updated": "Tarea actualizada",
        "task_marked_done": "Tarea marcada como hecha",
        "task_not_found": "No se encontr�� la tarea",
        "task_list_header": "Tus tareas:",

        "unexpected_error": "Ocurri�� un error inesperado",
        "db_error": "Error de base de datos",
        "due_date_invalid": "La fecha no es vǭlida (usa DD/MM)",
        "password_weak": "La contrase��a es dǸbil",
    }
...
def has_key(clave: str) -> bool:
    """True si la clave existe en el catǭlogo actual."""
